...
#
# ----------------------------------------------------------------------------------------------------------------------
# | This PowerShell script will enable disk encryption for the Adventure Works VMs                                     |
# |                                                                                                                    |
# | Please ensure you read the script instructions                                                                     |
# |                                                                                                                    |
...
########################################################################################################################
    ...
    if(-not $SvcPrincipals)
    {
        ...
        $defaultHomePage = 'http://advworks.com';
...
#    $vmName2 = 'ADVWORKS-VM2';
#    Set-AzureRmVMDiskEncryptionExtension -ResourceGroupName $resourceGroupName -VMName $vmName2 -AadClientID $aadClientID -AadClientSecret $aadClientSecret -DiskEncryptionKeyVaultUrl $diskEncryptionKeyVaultUrl -DiskEncryptionKeyVaultId $keyVaultResourceId;
########################################################################################################################
